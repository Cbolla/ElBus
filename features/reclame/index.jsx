    ...
    <div>
        <Page>
            <Screen>
                ...
                <textarea className='p-4 pl-10 pr-10 resize-none whitespace-normal text-white outline-none outline-[#DEAB14] mt-8 w-[90%] h-52 border-none rounded-[20px] bg-[#26292F]' type="text" name="text" id="" placeholder='Digite o que esta acontecendo aqui.' />
